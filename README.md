...
- **Noise System** — การยิงปืน ทุบ งัด พัง หรือทำเสียงดังจะเพิ่ม Noise และดึงดูดอันตรายตอนออกสำรวจ
- **Infection System** — แผลสกปรก โดนกัด เลือด สนิม ศพ หรือน้ำเน่าจะเพิ่ม Infection และค่อย ๆ ลด HP ถ้าไม่รักษา
- **Durability System** — เครื่องมือ/อาวุธที่ใช้ใน event จะสึกหรอ และไอเทมที่ใช้ได้จะแสดงจำนวนครั้งที่เหลือ
...
Noise คือค่าความดังที่ผู้เล่นสร้างระหว่างเอาตัวรอด:

- เพิ่มจากตัวเลือกที่มีการยิงปืน ทุบประตู พังกระจก ตะโกน งัด หรือใช้ชะแลง
- ลดลงเองทีละน้อยเมื่อเวลาผ่านไป
- ถ้า Noise สูง ตอนกดออกสำรวจมีโอกาสโดนอันตราย/ศัตรูตามเสียง ทำให้เสีย HP และเหนื่อยขึ้น

### Infection

Infection คือความเสี่ยงติดเชื้อจากบาดแผลและสภาพแวดล้อม:

- เพิ่มจากการโดนกัด แผลสกปรก เลือด สนิม ศพ ซากเน่า หรือน้ำเน่า
- ถ้าสูงเกินระดับเตือน จะค่อย ๆ กัด HP ระหว่างเวลาเดิน
- ถ้าหิวจัด กระหายน้ำจัด หรือเหนื่อยมาก การติดเชื้อจะค่อย ๆ แย่ลง
- ยา ผ้าพันแผล และชุดปฐมพยาบาลช่วยลด Infection ได้

### Durability

Durability ทำให้ไอเทมไม่ใช่ของถาวร:

- เครื่องมือ/อาวุธที่ถูกใช้ใน event เช่น ชะแลง มีด ไฟฉาย เชือก จะลด durability
- ถ้า durability เหลือ 0 ไอเทมนั้นจะหายจากกระเป๋า
- หน้า inventory แสดงจำนวนครั้งที่เหลือของไอเทมที่มี durability
- ไอเทมกิน/ดื่ม/รักษาเป็นของใช้แล้วหมดตามปกติ
